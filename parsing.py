...
def add_parse_args(parser):
    ...
    parser.add_argument('--name', default='TwistedFate', type=str)
    parser.add_argument('--data_folder', default='data/meta/metaqa-3hop/', type=str)
    ...
    parser.add_argument('--fake_entities', default=False, type=bool)
    parser.add_argument('--fake2id', default='heyman_space.txt', type=str)
    ...
    parser.add_argument('--lm', default='roberta', type=str, choices=['lstm', 'bert', 'roberta', 'sbert', 't5','sbert2'])
    ...
    parser.add_argument('--lr', default=0.0025, type=float) # 5e-4
    parser.add_argument('--decay_rate', default=0.0, type=float)
    parser.add_argument('--seed', default=19991004, type=int)
    ...
    # model options
    # parser.add_argument('--trainqa', default=100, type=int)
    # parser.add_argument('--completeness', default=100, type=int)
    parser.add_argument('--edge_extension', default=True, type=bool)
    parser.add_argument('--mean_extension', default=True, type=bool)
    parser.add_argument('--eps_fake', default=0.3, type=float)

    # model options
    # parser.add_argument('--is_eval', action='store_true')
    parser.add_argument('--is_eval', default=False, type=bool)
    parser.add_argument('--checkpoint_dir', default='checkpoint/Evaluate/', type=str)
    parser.add_argument('--log_level', type=str, default='info')
    parser.add_argument('--experiment_name', default='CallofAbyss', type=str)
    # parser.add_argument('--load_experiment', default='Base.ckpt', type=str)
